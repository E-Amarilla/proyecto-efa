...
const Layout = () => {
  ...
  const sections = [
    { id: 1, name: "Posicionador de torres", path: "/desmoldeo/equipox", style: { top: "8.6%", left: "73%", width: "10.1%", height: "66%" }, styleclass: "Torresection" },
    ...
    { id: 5, name: "Estación de grippers", path: "/desmoldeo/equipox", style: { top: "68.6%", left: "47.55%", width: "8.8%", height: "19.5%" }, styleclass: "Estacionsection" },
