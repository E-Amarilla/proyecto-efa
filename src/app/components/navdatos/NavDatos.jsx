...
const NavDatos = () => {
    ...
    const opcionesAlarma = [
        { id: 1, nombre: 'LAYOUT' },
        { id: 2, nombre: 'PRODUCTIVITY' },
        { id: 3, nombre: 'HISTORIC GRAPHS' },
    ];

    const datosTiempoReal = [
        { id: 1, nombre: 'Recip Name', dato: NombreActual !== undefined && NombreActual !== null ? NombreActual : 'null', icono:receta1  },
        { id: 2, nombre: 'Next recipe ID', dato: idRecetaProxima !== undefined && idRecetaProxima !== null ? idRecetaProxima : 'null', icono:receta2  },
        { id: 3, nombre: 'Actual Gripper N°', dato: NGripperActual !== undefined && NGripperActual !== null ? NGripperActual : 'null', icono:gripper  },
        { id: 4, nombre: 'Weight per row', dato: PesoProducto !== undefined && PesoProducto !== null ? PesoProducto : 'null', icono:peso  },
        { id: 5, nombre: 'Demolded weight', dato: PesoActualDesmoldado !== undefined && PesoActualDesmoldado !== null ? PesoActualDesmoldado : 'null', icono:peso  },
        { id: 6, nombre: 'Actual Tower N°', dato: torreActual !== undefined && torreActual !== null ? torreActual : 'null', icono:torre  },
        { id: 7, nombre: 'Actual Tower Level', dato: (sdda_nivel_actual !== undefined && sdda_nivel_actual !== null ? sdda_nivel_actual : 'null') + "/" + (TotalNiveles !== undefined && TotalNiveles !== null ? TotalNiveles : 'null'), icono:nivelactual  },
        { id: 8, nombre: 'Mould N°', dato: TipoMolde !== undefined && TipoMolde !== null ? TipoMolde : 'null', icono:molde  },
        { id: 9, nombre: 'Time Elapsed', dato: TiempoTranscurrido !== undefined && TiempoTranscurrido !== null ? TiempoTranscurrido : '00:00 mm:ss', icono:tiempo  },
    ];
